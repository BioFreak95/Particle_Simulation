...
class TestMetropolisMonteCarlo(unittest.TestCase):
    ...
    def test_shift_position(self):
        ...
        reference_pos_1 = np.array([ 1.5, 1.0, 1.5])
        reference_pos_2 = np.array([ 10.5, 12.0, 5.5])
        ...
        npt.assert_equal(reference_pos_1, shifted_position_1, 'Failed', verbose=True)
        npt.assert_equal(reference_pos_2, shifted_position_2, 'Failed', verbose=True)
    
    # to check behavior of trial_positions 
